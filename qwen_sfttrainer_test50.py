#!/usr/bin/env python3
"""
Quick test: Qwen2.5-VL with SFTTrainer on 50 samples
"""
...
print("=" * 80)
print("🧪 TEST: QWEN2.5-VL WITH SFTTRAINER (50 SAMPLES)")
print("=" * 80)
...
print(f"\n🔄 Filtering first {MAX_SAMPLES} samples (no multiprocessing)...")
...
# ==================== TRAINING CONFIG ====================
print("\n📋 Setting up training (50 steps)...")

training_args = SFTConfig(
    output_dir='./checkpoint-qwen-test-50',
    num_train_epochs=1,
    per_device_train_batch_size=2,
    gradient_accumulation_steps=2,
    max_steps=25,  # Just 25 steps for quick test
    warmup_steps=5,
    learning_rate=1e-4,
    bf16=True,
    logging_steps=5,
...
# ==================== TRAIN ====================
print("\n" + "=" * 80)
print("🚀 STARTING TEST TRAINING (25 STEPS)")
print("=" * 80 + "\n")

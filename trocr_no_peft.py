#!/usr/bin/env python3
"""
🎯 TrOCR Training - NO PEFT/LoRA (Baseline Test)
Test if base model trains without device issues
"""
...
print("=" * 80)
print("🎯 TROCR TRAINING - NO PEFT (Device Baseline Test)")
print("=" * 80)
...
# Training loop
print("\n" + "=" * 80)
print("🚀 STARTING TRAINING (NO PEFT)")
print("=" * 80 + "\n")
...
for batch_idx in range(0, len(processed), BATCH_SIZE):
    ...
    try:
        ...
        current_batch = batch_idx // BATCH_SIZE + 1
        print(f"❌ Error in batch {current_batch}: {str(e)[:100]}")
        import traceback
        traceback.print_exc()

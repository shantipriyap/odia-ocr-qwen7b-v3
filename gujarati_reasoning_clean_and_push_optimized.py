...
batch_size = 32  # Try a larger batch size for speed
max_new_tokens = 128  # Reduce if your outputs are short
...
print("Translating and cleaning data in optimized batches...")
